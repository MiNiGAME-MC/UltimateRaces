package net.ryu.ultimateraces.utils.inventory;
...
public class Inventories implements InventoryHolder {
     ...
     */
    public Inventories(int size, String title) {
     ...
     */
    public Inventories(InventoryType type) {
     ...
     */
    public Inventories(InventoryType type, String title) {
        this(0, type, title);
    }

    private Inventories(int size, InventoryType type, String title) {
